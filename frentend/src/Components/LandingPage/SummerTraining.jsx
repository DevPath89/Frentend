    ...
    <div>
      ...
      <section className="bg-warning text-dark py-5">
        <div className="container text-center">
          <h1 className="fw-bold">Summer Training Program</h1>
          <p className="lead">
            DevPath Technology offers 45-60 days intensive training for B.Tech, BCA, MCA students.
          </p>
      ...
      <section className="py-5 bg-light">
        <div className="container">
          <h2 className="text-center mb-5">Offered Languages and Technology Of DevPath Summer Training</h2>
          <div className="row">
      ...
      <section className="py-5 text-center">
        <div className="container">
          <h2 className="mb-3">Join Our Summer Training Program</h2>
